...
const PROJECTS = [
  ...
  {
    id: "revolver",
    titleRu: "Револьвер — sci-fi",
    titleEn: "Revolver — sci-fi",
    cats: ["weapons"],
    cover: "rev.jpg",
    images: ["rev.jpg", "rev2.jpg"],
  },
  {
    id: "shuriken",
    titleRu: "Сюрикен",
  ...
  {
    id: "control-device",
    titleRu: "Пульт управления",
    titleEn: "Control device",
    cats: ["graphics", "stylized"],
    cover: "pult.jpg",
    images: ["pult.jpg"],
  },
  {
    id: "control-device-video",
    titleRu: "Пульт управления — анимация",
    titleEn: "Control device — turntable",
    cats: ["graphics", "turntables", "stylized"],
    type: "video",
    poster: "video/pult_poster.jpg",
    video: "video/pult.mp4",
  },
];
